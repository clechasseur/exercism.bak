...
def round_to_two_decimals(n):
    # Python has a round() function, but it can apparently cause slight floating-point
    # rounding errors, so I used the decimal module; not sure it's idiomatic however.
